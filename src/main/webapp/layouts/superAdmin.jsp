...
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/resources/css/stable.css" />
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/resources/css/home.css" />
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/resources/css/temp.css" />
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/resources/css/mathquill.css" />
...
<body>
	...
	<div class="wrapper">
		...
		<div class="container">
			<div class="leftbar">
				<jsp:include page="/templates/admin/super/_leftbar.jsp" /></div>
			<div class="content">
				<sitemesh:write property='body' />
			</div>
			<div class="rightbar">
				<jsp:include page="/templates/admin/super/_rightbar.jsp" />
			</div>
